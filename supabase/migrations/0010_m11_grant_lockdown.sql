-- ============================================================
-- 0010_m11_grant_lockdown.sql — finish what 0008 intended.
--
-- 0008 GRANTed minimal privileges but never REVOKEd the Supabase default ALL
...
-- policies are read-only or owner-fenced), but the posture contradicts 0008's
...
-- community tables already got in 0009. Idempotent (revoke/grant are no-ops on
-- repeat).
-- ============================================================
