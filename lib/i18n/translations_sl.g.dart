...
class _Translations$moon$task_section$sl extends Translations$moon$task_section$en {
	_Translations$moon$task_section$sl._(TranslationsSl root) : this._root = root, super.internal(root);
