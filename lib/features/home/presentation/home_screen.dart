...
class HomeScreen extends ConsumerStatefulWidget {
  ...
  /// Suggestion id from a tapped push deep link (M11); the band card flashes
  /// briefly. Always null while suggestions are dark (kSuggestionsEnabled).
      ...
      child: SlidableAutoCloseBehavior(
        child: ListView(
          ...
          children: [
            ...
            // Smart-suggestion band (M11) — dark until launch (kSuggestionsEnabled).
