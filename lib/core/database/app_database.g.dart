...
class $DeviceLocationsTable extends DeviceLocations
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'device_location';
  @override
  VerificationContext validateIntegrity(
    Insertable<DeviceLocation> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class DeviceLocation extends DataClass implements Insertable<DeviceLocation> {
  ...
  factory DeviceLocation.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  DeviceLocation copyWithCompanion(DeviceLocationsCompanion data) {
    return DeviceLocation(
      id: data.id.present ? data.id.value : this.id,
...
typedef $$SyncCursorsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$DeviceLocationsTableCreateCompanionBuilder =
    DeviceLocationsCompanion Function({
      Value<int> id,
      required double latitude,
      required double longitude,
      required DateTime updatedAt,
    });
typedef $$DeviceLocationsTableUpdateCompanionBuilder =
    DeviceLocationsCompanion Function({
      Value<int> id,
      Value<double> latitude,
      Value<double> longitude,
...
class $$DeviceLocationsTableFilterComposer
    extends Composer<_$AppDatabase, $DeviceLocationsTable> {
  $$DeviceLocationsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$DeviceLocationsTableOrderingComposer
    extends Composer<_$AppDatabase, $DeviceLocationsTable> {
  $$DeviceLocationsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$DeviceLocationsTableAnnotationComposer
    extends Composer<_$AppDatabase, $DeviceLocationsTable> {
  $$DeviceLocationsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$DeviceLocationsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          ...
          $$DeviceLocationsTableOrderingComposer,
          $$DeviceLocationsTableAnnotationComposer,
          $$DeviceLocationsTableCreateCompanionBuilder,
          $$DeviceLocationsTableUpdateCompanionBuilder,
          (
            DeviceLocation,
            BaseReferences<
              _$AppDatabase,
          ...
          PrefetchHooks Function()
        > {
  $$DeviceLocationsTableTableManager(
    _$AppDatabase db,
    $DeviceLocationsTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$DeviceLocationsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$DeviceLocationsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$DeviceLocationsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
...
typedef $$DeviceLocationsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $DeviceLocationsTable,
      DeviceLocation,
      ...
      (
        DeviceLocation,
        BaseReferences<_$AppDatabase, $DeviceLocationsTable, DeviceLocation>,
      ),
      DeviceLocation,
      PrefetchHooks Function()
    >;
