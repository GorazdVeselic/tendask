...
(isto varovalo; vstop ⚙️ v AppBar koledarja, vstop iz `/tendask-plus` pride s T6). Ostale rute
(`/tendask-plus`, `/moon-finder`) pridejo s svojimi taski, vsaka z istim varovalom.
