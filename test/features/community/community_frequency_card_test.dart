...
FrequencyStats _stats(Map<String, int> hist) => FrequencyStats(
  bucket: _bucket,
  p25: 2,
  p50: 3,
  p75: 4,
...
void main() {
  ...
  testWidgets('a band nobody landed in is still drawn, in its place', (
    ...
    final bars = await _pump(tester, hist: {'1': 4, '3': 12, '5+': 3}, myCount: 1);
  ...
  testWidgets('my own bar is my count, not the "5+" fallback', (tester) async {
    ...
    final bars = await _pump(tester, hist: {'1': 4, '3': 12, '5+': 3}, myCount: 2);
